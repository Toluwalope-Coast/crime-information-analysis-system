                    ...
                    <div class="field">
                        <div class="form-group mx-auto">
                            ...
                            <select name="updateColumn" class="custom-select neo-flat text-dark" id="updateColumn">
                                ...
                                <option value="role_in_case">Role In Case</option>
                                <option value="arresting_officer">Arresting Officer</option>
                                <option value="place_of_arrest">Place Of Arrest</option>
                                <option value="arresting_station">Arresting Station</option>
                                <option value="arrest_status">Arrest Status</option>
                                <option value="mode_of_release">Mode Of Release</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group mx-auto">
                            <label for="arrest_ID" class="label label2 mb-3 mt-3">
                                Where Arrest Id is:</label>
                            <input type="number" id="arrest_ID" name="arrest_ID"
                                class="form-control py-4 pl-4 neo-pressed mb-2"
