...
<li class="nav-item top-side-menu-items pt-1 mt=2">
    ...
    <div class="main2 d-flex flex-column">
        ...
        <ul class="nav nav-pills sub-menu d-flex flex-row-reverse float-sm-right">
            <li class="nav-item sub-menu-item sub-menu-last-item-active bg-white">
        ...
        <div class="h-100 outer-form2 mx-auto p-5">
            ...
            <form id="regForm" action="functions" class="needs-validation form-control border-0 p-4 w-100 h-100"
                validated>

                <div class="page slidepage mt-2 w-100">
                    <div class="field">
                        <div class="form-group mx-auto">
                            <label for="case_id" class="label label2 mb-4 mt-4">
                                Where Case Id is:</label>
                            <input type="text" id="case_id" name="case_id"
                                class="form-control py-4 pl-4 neo-pressed mb-2"
                                placeholder="Enter the Case Id for the row to delete here" required />
