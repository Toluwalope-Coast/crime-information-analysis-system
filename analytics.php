...
<div class="d-flex flex-row top-row">
    ...
    <div class="main d-flex flex-column">
        ...
        <h1 class="text-center text-dark main-head mt-5 mb-3``````` analytics">
            Analytics Home
        </h1>
        ...
        <section class="analytics">
            <div class="jumbotron">
                ...
                <a class="text-primary text-center" href="case_analytics.php">Case / Crime Chart</a></h3>
                <canvas class="crimeChart">
                </canvas>
            </div>
                </section>
        <section class="analytics">
            <div class="jumbotron">
                <h3 class="text-primary text-center">Arrest Chart</h3>
                <canvas class="crimeChart">
                </canvas>
            </div>
        ...
        <section class="analytics">
            <div class="jumbotron">
                <h3 class="text-primary text-center">Evidence Chart</h3>
                <canvas class="crimeChart">
            </div>
        ...
        <section class="analytics">
            <div class="jumbotron">
                <h3 class="text-primary text-center">Criminal Chart</h3>
                <canvas class="crimeChart">
            </div>
        </section>
