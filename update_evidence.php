...
<title>Update Evidence Record</title>
...
<div class="d-flex flex-row top-row">
    ...
    <div class="main2 d-flex flex-column">
        ...
        <div class="h-100 outer-form2 mx-auto p-5">
            ...
            <form id="regForm" action="functions/preprocess_update_evidence_file.php" method="post"
                    ...
                    <div class="field">
                        <div class="form-group mx-auto">
                            ...
                            <select name="updateColumn" class="custom-select neo-flat text-dark" id="updateColumn">
                                ...
                                <option value="description">Evidence Description</option>
                                <option value="evidence_label_no">Evidence Label No</option>
                                <option value="place_found">Place Found</option>
                                <option value="role_in_case">Evidence Role In Case</option>
                        ...
                        <div class="form-group mx-auto">
                            <label for="evidence_ID" class="label label2 mb-3 mt-3">
